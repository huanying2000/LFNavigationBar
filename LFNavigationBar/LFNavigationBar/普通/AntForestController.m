...
- (void)viewDidLoad {
    ...
    [self lf_setNavBarBarTintColor:[UIColor whiteColor]];
    [self lf_setNavBarBackgroundAlpha:0];
    [self lf_setNavBarShadowImageHidden:NO];
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (offsetY > NAVBAR_COLORCHANGE_POINT)
    {
        ...
        if (alpha > 0.5) {
            [self lf_setNavBarTintColor:[UIColor colorWithRed:0 green:0.478431 blue:1 alpha:1.0]];
            [self lf_setNavBarTitleColor:[UIColor blackColor]];
