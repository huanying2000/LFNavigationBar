...
- (void)viewDidLoad
{
    ...
    innerVC.view.frame = CGRectMake(0, 300, [LFNavigationBar screenWidth], 300);
...
- (void)viewDidLoad {
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 100, [LFNavigationBar screenWidth], 100)];
