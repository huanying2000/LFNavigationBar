...
- (void)viewDidLoad
{
    ...
    [self lf_setNavBarBarTintColor:[UIColor colorWithRed:28/255.0 green:178/255.0 blue:140/255.0 alpha:1.0]];
...
- (void)updateNavBarButtonItemsAlphaAnimated:(CGFloat)alpha
{
    [UIView animateWithDuration:0.2 animations:^{
        [self.navigationController.navigationBar lf_setBarButtonItemsAlpha:alpha hasSystemBackIndicator:NO];
    }];
}
...
- (void)updateSearchBarColor:(CGFloat)alpha
{
    ...
    image = [image updateImageWithTintColor:color alpha:alpha];
